...
class machine_state_generator():
    ...
    def genMachineStates(self):
        if(self.reflow_flag):
            ...
            cur1 = pd.DataFrame(columns = ['timestamp', 'current', 'state'])
            cur1['timestamp'] = self.rf_vaf['timestamp']
            cur1['current'] = self.rf_vaf['data.A1']
...
if __name__=='__main__':
    ...
    _,df_rf_states=data_rfo.genMachineStates()
    print(df_rf_states)
